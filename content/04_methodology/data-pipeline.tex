...
2024-09-05 to 2026-04-24 (\num{401} returns). The chronological split was explicitly used to avoid look-ahead bias. Following the current split, the 2021 to 2022 price disruption discussed in Sec.~\ref{sec:gas-markets} falls entirely within the training period. The validation period is calm, while the 2026 disruption falls entirely within the test period, as seen in Figure~\ref{fig:ttf-price-split}.
