...
Distributional statistics were computed for $x$ and $\hat{x}_{\mathrm{pool}}$: mean, standard deviation, skewness, excess kurtosis, minimum, maximum, $1\%$ and $99\%$ quantiles. Skewness and excess kurtosis measure the asymmetry and the tail weight described in Sec.~\ref{sec:stylized-facts}. Additionally, the fractions of returns exceeding $5\%$ and $10\%$ in absolute value were computed. The fraction of observations whose absolute value exceeds $u$ is denoted as $P(|x| > u)$. The exceedance fractions measure the frequency of extreme returns, which determines the value of out-of-the-money options (Sec.~\ref{sec:options}).
