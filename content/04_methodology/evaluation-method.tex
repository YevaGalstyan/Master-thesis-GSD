...
Lastly, the mode collapse described in Sec.~\ref{sec:fin-gan} was checked. For distributional mode collapse, the standard deviation of each row of $\hat{X}$ was computed. The smallest value was compared with $\epsilon=0.0002$. For mean mode collapse, the standard deviation of $m$ was compared with the same $\epsilon$ value.
